...
#
#    CentOS 7 (centos7) PHP Stack - HTTPd24 Web Server (dockerfile)
...
# Base image to use
FROM stafli/stafli.web.httpd:httpd24_centos7
...
ARG app_httpd_vhost_fpm_addr="php56_stack_language_php56_centos7_1"
